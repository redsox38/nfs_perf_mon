...
struct sniff_rpc {
  u_int xid;           /* rpc transaction id */
  u_int type;          /* message type */
  u_int rpc_vers;      /* rpc version */
  u_int prog_id;       /* rpc program number */
  u_int prog_vers;     /* rpc program version */
  u_int prog_proc;     /* rpc procedure */
};
